...
describe('isEmpty', () => {
    it('should return true on empty string', () =>
        assert.strictEqual(ow.isEmpty(''), true)
    );
    ...
    it('should return false on non empty array', () =>
        assert.strictEqual(ow.isEmpty([1]), false)
    );

    it('should return true on empty obj', () =>
        assert.strictEqual(ow.isEmpty({}), true)
    );

    it('should return false on non empty obj', () =>
        assert.strictEqual(ow.isEmpty({a:1}), false)
    );

    it('should return true on null', () =>
        assert.strictEqual(ow.isEmpty(null), true)
    );

    it('should return false on function', () =>
        assert.strictEqual(ow.isEmpty(() => {}), false)
    );
