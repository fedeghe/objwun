...
var objwun = (function() {
    ...
    */
    +function () {
        ...
        function isFunc(o) { return typeof o === 'function' }
        ...
        function isBigint(o) { return typeof o === 'bigint' }
        ...
        function isPrimitive(v){
            return v === null
                || (typeof v).match(/symbol|string|number|boolean|ndefined|bigint/)
        }
        function isObj(v){ return !isPrimitive(v)}
